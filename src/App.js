...
const App = () => {
  ...
  const initialColumns = {
    todo: {
      id: "todo",
      list: [
        { id: "1", text: "text1", name:"Running", description:"Run for 12 mins" },
        { id: "2", text: "text2",name:"Yoga", description:"yoga blah" },
      ]
    },
    doing: {
      id: "doing",
      list: [
        { id: "3", text: "text4", name:"Swimming", description:"Hold breath for 1 min" },
        { id: "5", text: "text5", name:"Blah", description:"Blah Blah Blah" }
      ]
    },
    done: {
      id: "done",
